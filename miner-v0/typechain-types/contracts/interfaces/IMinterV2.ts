...
export interface IMinterV2Interface extends Interface {
...
export interface IMinterV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IMinterV2;
  waitForDeployment(): Promise<this>;

  interface: IMinterV2Interface;

...
export interface MinterV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "l1ScrollMessenger"
      | "mint"
...
export interface MinterV2 extends BaseContract {
  connect(runner?: ContractRunner | null): MinterV2;
  waitForDeployment(): Promise<this>;

  interface: MinterV2Interface;

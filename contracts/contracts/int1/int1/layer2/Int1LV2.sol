...
import {DepositQueueLibV2} from "../../../lib/DepositQueueLibV2.sol";
...
contract Int1LV2 is IInt1, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    DepositQueueLibV2.DepositQueue private depositQueue;
    ...
    modifier canCancelDeposit(
        ...
        DepositQueueLibV2.DepositData memory depositData = depositQueue
    ...
    function getDepositData(
        uint256 depositId
    ) external view returns (DepositQueueLibV2.DepositData memory) {
    ...
    function getDepositDataBatch(
        ...
        DepositQueueLibV2.DepositData[]
            memory depositData = new DepositQueueLibV2.DepositData[](
                depositIds.length
            );

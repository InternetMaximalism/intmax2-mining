...
async fn initial_balance(
    ...
    let single_deposit_gas_fee: U256 = settings.blockchain.single_deposit_gas_fee.into();
    let single_claim_gas_fee: U256 = settings.blockchain.sinlge_claim_gas_fee.into();
